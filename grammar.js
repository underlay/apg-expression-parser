...
var grammar = {
    ...
    {"name": "expr", "symbols": [(lexer.has("slash") ? {type: "slash"} : slash), "__", "expression", "__", (lexer.has("modulo") ? {type: "modulo"} : modulo), "__", "uri"], "postprocess": (r) => ({ type: "injection", key: r[6], value: r[2] })},
    ...
    {"name": "link$subexpression$1", "symbols": [(lexer.has("bslash") ? {type: "bslash"} : bslash)], "postprocess": (r) => "option"},
